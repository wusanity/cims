...
<div class="content" >
   ...
   <form action="/cims/startInstance" id="startInstance" style="position:relative;left:350px" id="gTemplate">
	    <table bgcolor=white border="2" cellspacing="0" width="50%" height="150">
	        <caption style="font-size:20px;text-align:center;">${str1}</caption>
	    ...
	    <input type="button" onclick="submitTemplate();" style="font-size: 25px;font-weight: 700;text-align:center;position:relative;left:350px;" value="发表">
   </form>
</div>
<div class="footer">
</div>
